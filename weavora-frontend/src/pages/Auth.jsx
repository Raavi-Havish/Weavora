    ...
    <div className="min-h-[85vh] flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-weavora-dark relative overflow-hidden items-center justify-center">
        ...
        <div className="relative z-10 text-center px-12">
          ...
          <p className="text-weavora-light text-xl">Unlock exclusive styles, fast checkout, and custom fits.</p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gray-50">
        <div className="w-full max-w-md bg-white rounded-3xl shadow-xl p-10 border border-gray-100">
          ...
          <p className="text-gray-500 mb-6">
            {showOtp ? 'We sent a 6-digit code to your email.' : 'Please enter your details to continue.'}
          </p>
          ...
          {!showOtp && (
            <div className="mt-8 text-center">
              <p className="text-gray-600">
                ...
                <button type="button" onClick={() => setIsLogin(!isLogin)} className="text-weavora-dark font-bold hover:text-weavora-light transition-colors">
