  ...
  return (
    <div className="min-h-[85vh] flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-weavora-dark relative overflow-hidden items-center justify-center">
        ...
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1490481651871-ab68de25d43d?q=80&w=1000&auto=format&fit=crop')] mix-blend-overlay opacity-20 object-cover w-full h-full"></div>
        <div className="relative z-10 text-center px-12">
          <h2 className="text-5xl font-extrabold text-white mb-6">Welcome Back.</h2>
          <p className="text-weavora-light text-xl">Sign in to access your curated fits.</p>
        </div>
      </div>
        ...
        <div className="w-full max-w-md bg-white rounded-3xl shadow-xl p-10 border border-gray-100">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <div className="flex justify-between mb-1">
                ...
                <Link to="/forgot-password" className="text-sm text-weavora-dark hover:text-weavora-light font-medium">Forgot Password?</Link>
              </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-600">
              Don't have an account? <Link to="/register" className="text-weavora-dark font-bold hover:text-weavora-light transition-colors">Sign Up</Link>
            </p>
          </div>
        </div>
      </div>
